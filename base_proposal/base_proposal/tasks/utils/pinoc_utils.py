...
class PinTiagoIKSolver(object):
    ...
    def solve_ik_pos_tiago(self, des_pos, des_quat, curr_joints=None, n_trials=100, dt=0.1, pos_threshold=0.05, angle_threshold=15.*np.pi/180, verbose=False, Rmin= [-4,-4,0,-1], Rmax = [4,4,1,1], quick =False):
